/**
 * Convergence design tokens — single source of truth (IMPLEMENTATION_PLAN §8.3).
 * Transcribed verbatim from DESIGN.md front-matter. Consumed by every app's
 * Tailwind config. Do not redefine values elsewhere.
 */
export const colors = {
  primary: "#0F172A",
  "on-primary": "#FFFFFF",
